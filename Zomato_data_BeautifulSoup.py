...
for page in range(0,10):
    #print(page_no)
    response = requests.get("https://www.zomato.com/praha/restaurants?page={0}".format(page_no), headers=headers)
    ...
    for i in range(0,15):
        ...
        opening_hours = rest6[0].find("div", {'class': 'col-s-11 col-m-12 pl0 search-grid-right-text'})
        ...
        dataframe["opening_hours"] = opening_hours.string[1:]
